                    ...
                    <div class="card-body">
                        <form @submit.prevent="this.edit_mode ? updateInvoice() : createInvoice()" @keydown="form.onKeydown($event)" class="form-horizontal"> 
                            <!-- <div class="modal-body"> -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>This option is used to generate invoices that will be treated as deductions in the landlord's account for the services rendered in a given period. E.g. Management Commission</p>
                                        <hr>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="form-label col-md-3" >Select Landlord</label>
                                    <div class="col-md-9">
                                        <v-select v-model="form.landlord_id" :value="form.landlord_id" :options="landlords.data" label="landlord_name" name="landlord_id" @input="getUnits(form.property_id.property_id)" :class="{ 'is-invalid': form.errors.has('landlord_id') }">
                            ...
                            <div class="modal-footer justify-content-between">
                                <button :disabled="form.busy" @click.prevent="edit_mode ? updateInvoice() : createInvoice()" class="btn btn-sm btn-success"><i class="fa fa-check"></i> GENERATE</button>
                            </div>
                        </form>
                    </div>
