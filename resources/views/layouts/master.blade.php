...
<head>
  ...
  <title>Uwezo - User Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{ url('public/img/logo.png') }}" alt="Uwezo Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">UWEZO</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">          
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">              
              ...
              <li class="nav-item">
                <router-link to="/properties/types" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Types & Utilities</p>
                </router-link>
              </li>              
          ...
          <li class="nav-item">
            <router-link to="/landlords" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">              
              ...
              <li class="nav-item">
                <router-link to="/work_orders" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Work Orders</p>
                </router-link>
              </li>              
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">              
              ...
              <li class="nav-item">
                <router-link to="/service_charges" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Service Charges</p>
                </router-link>
              </li>            
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">              
              ...
              <li class="nav-item">
                <router-link to="/mpesa" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>M-PESA</p>
                </router-link>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">              
              <li class="nav-item">
                <router-link to="/reports/company" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Company</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/reports/properties" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Property</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/reports/tenants" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Tenants</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/reports/invoices" class="nav-link">
                  <i class="fa fa-long-arrow-right nav-icon"></i>
                  <p>Invoices</p>
                </router-link>
              </li>
